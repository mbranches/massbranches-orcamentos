...
public class UserUtils {
    public static List<User> newUserList() {
        ...
        User user1 = User.builder().id("id-uui-1").firstName("Admin").lastName("One").email("admin@branches.dev").password("encrypted-password-1").createdAt(createdAt1).updatedAt(createdAt1).active(true).build();
        ...
        User user2 = User.builder().id("id-uui-2").firstName("Marcus").lastName("Branches").email("branches@branches.dev").password("encrypted-password-2").createdAt(createdAt2).updatedAt(createdAt2).active(false).build();
        ...
        User user3 = User.builder().id("id-uui-3").firstName("Vinicius").lastName("Silva").email("v.silva@branches.dev").password("encrypted-password-3").createdAt(createdAt3).updatedAt(createdAt3).active(true).build();
    ...
    public static List<UserGetResponse> newUserGetResponseList() {
        return newUserList().stream().map(UserGetResponse::by).toList();
    }
    ...
    public static LoginResponse newLoginResponse() {
        return new LoginResponse("access-token-admin-jwt");
    }
}
