...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
    return (
        <>
            ...
            <div className={`w-[310px] h-screen z-50 transition-transform duration-100 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:z-auto bg-white shadow-xl overflow-y-auto`}>
